...
class UnCLIPImageVariationPipelineFastTests(PipelineTesterMixin, unittest.
    ...
    def dummy_image_encoder(self):
        paddle.seed(0)
        config = CLIPVisionConfig(hidden_size=self.
            text_embedder_hidden_size, projection_dim=self.
            text_embedder_hidden_size, num_hidden_layers=5,
    ...
    def get_dummy_components(self):
        ...
        return {'decoder': decoder, 'text_encoder': text_encoder,
            'tokenizer': tokenizer, 'text_proj': text_proj,
            'feature_extractor': feature_extractor, 'image_encoder':
            image_encoder, 'super_res_first': super_res_first,
    ...
    def test_unclip_passed_image_embed(self):
        ...
        img_out_2 = pipe(**pipeline_inputs, decoder_latents=decoder_latents,
            super_res_latents=super_res_latents, image_embeddings=

...
class StableUnCLIPImg2ImgPipelineFastTests(PipelineTesterMixin, unittest.
    TestCase):
    ...
    def get_dummy_components(self):
        ...
        image_encoder = CLIPVisionModelWithProjection(CLIPVisionConfig(
            ...
            embedder_projection_dim, num_hidden_layers=5,
        ...
        components = {'feature_extractor': feature_extractor,
            'image_encoder': image_encoder, 'image_normalizer':
    ...
    def test_xformers_attention_forwardGenerator_pass(self):
        self._test_xformers_attention_forwardGenerator_pass(test_max_difference
            =False)

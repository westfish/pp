...
class VersatileDiffusionMegaPipelineIntegrationTests(unittest.TestCase):
    ...
    def test_inference_dual_guided_then_text_to_image(self):
        ...
        expected_slice = np.array([0.03100586, 0.02929688, 0.03271484, 0.02807617, 0.02905273,
                                    0.03173828, 0.02685547, 0.02807617, 0.03271484])
        ...
        expected_slice = np.array([0.0390625 , 0.00854492, 0.        , 0.03930664, 0.00878906,
                                    0.04711914, 0.03686523, 0.        , 0.0246582 ])
        assert np.abs(image_slice.flatten() - expected_slice).max() < 0.1
        ...
        expected_slice = np.array([0.34472656, 0.1940918 , 0.10546875, 0.38134766, 0.24560547,

...
class StableDiffusionPipelineIntegrationTests(unittest.TestCase):
    ...
    def test_stable_diffusion_1(self):
        ...
        expected_slice = np.array([0.7477613 , 0.76045597, 0.7464366 , 0.778965  , 0.75718963,  0.7487634 , 0.77530396, 0.77426934, 0.7749926 ])
    ...
    def test_stable_diffusion_2(self):
        ...
        image_slice = image[0, -3:, -3:, -1]
        assert image.shape == (1, 512, 512, 3)
        expected_slice = np.array([0.8771595 , 0.8521123 , 0.8644101 , 0.8680052 , 0.8700466 ,    0.8897612 , 0.87766427, 0.8636212 , 0.86829203])
        assert np.abs(image_slice.flatten() - expected_slice).max() < 0.05

...
from ppdiffusers import FlaxDPMSolverMultistepScheduler, FlaxStableDiffusionPipeline
from ppdiffusers.utils import is_flax_available, slow
from ppdiffusers.utils.testing_utils import require_flax
...
class FlaxStableDiffusion2PipelineIntegrationTests(unittest.TestCase):
    ...
    def test_stable_diffusion_flax(self):
        ...
        expected_slice = jnp.array([0.4238, 0.4414, 0.4395, 0.4453, 0.4629, 0.459, 0.4531, 0.45508, 0.4512])
    ...
    def test_stable_diffusion_dpm_flax(self):
        ...
        sd_pipe, params = FlaxStableDiffusionPipeline.from_pretrained(
            model_id, scheduler=scheduler, revision="bf16", dtype=jnp.bfloat16
        )

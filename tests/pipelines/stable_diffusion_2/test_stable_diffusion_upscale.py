...
class StableDiffusionUpscalePipelineFastTests(unittest.TestCase):
    ...
    def dummy_cond_unet_upscale(self):
        ...
        model = UNet2DConditionModel(block_out_channels=(32, 32, 64),
            layers_per_block=2, sample_size=32, in_channels=7, out_channels
    ...
    def dummy_vae(self):
        paddle.seed(0)
        model = AutoencoderKL(block_out_channels=[32, 32, 64], in_channels=
            3, out_channels=3, down_block_types=['DownEncoderBlock2D',

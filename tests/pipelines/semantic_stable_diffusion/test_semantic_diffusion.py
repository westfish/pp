...
class SemanticDiffusionPipelineIntegrationTests(unittest.TestCase):
    ...
    def test_positive_guidance(self):
        ...
        edit = {'editing_prompt': ['sunglasses'],
            'reverse_editing_direction': [False], 'edit_warmup_steps': 10,
            'edit_guidance_scale': 6, 'edit_threshold': 0.95,
    ...
    def test_multi_cond_guidance(self):
        ...
        edit = {'editing_prompt': ['boat on a river, boat',
            'monet, impression, sunrise'], 'reverse_editing_direction': 
            False, 'edit_warmup_steps': [15, 18], 'edit_guidance_scale': 6,
